...
import { useCoachStore } from '@features/coach/stores/coachStore';
import { CoachConsentModal } from '@features/coach/components/CoachConsentModal';
...
export function SettingsPage() {
  ...
  // Entrenador IA. El estado real vive en el servidor (profiles.ai_coach_enabled);
  // el store es un espejo y se corrige al abrir Ajustes.
