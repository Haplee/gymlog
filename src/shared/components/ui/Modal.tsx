                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  {showCloseButton && !title && (
                    <button
                      ...
                      className="absolute top-3 right-3 h-11 w-11 rounded-full flex items-center justify-center text-fg-subtle hover:bg-surface-2 hover:text-fg active:bg-hover transition-colors"
                    >
                      <Xmark size={16} />
                    </button>
                  )}
